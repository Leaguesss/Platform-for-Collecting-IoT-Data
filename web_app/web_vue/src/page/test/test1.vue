        ...
        <div>
            <div style='height: 70px;'>
                <el-form :inline="true" :model="form" ref="form" class="s-form-noerror" label-width="40px" label-position="left">
                    <el-row :gutter="5">
                        <el-col :span="5">
                            <el-form-item label="Warehouse store" style="width: 100%;">
            ...
            <s-table :dataSource="dataSource" :summary="tableSummary" :defaultQuery="tableQuery" ref="table" :height="tableHeight" responseData="list">
                <template v-if='viewType==0'>
                    ...
                    <el-table-column prop='storeName' label='Warehouse store' width='120' :sortable='true' :resizable="false">
                    </el-table-column>
                ...
                <template v-else>
                    ...
                    <el-table-column prop='storeName' label='Warehouse store' width='120' :sortable='true' :resizable="false"></el-table-column>
                    <el-table-column prop='colorId' label='颜色' width='100' :sortable='true' :resizable="false" :formatter='formatData'></el-table-column>
        ...
        data(){
            return{
                ...
                tableSummary:{
                    show:true,
                    list:[
                        {code:"s_num",name:"inventory data",value:0},
                        {code:"o_num",name:"transit",value:0},
                        {code:"tagSum",name:"Drop the amount",value:0},
                    ]
                },
                size:"tiny",
                dialog: {
